import type { RiskCategory, TrajectoryDirection, TrajectoryPoint } from '@/types/clinical';

/**
 * Mirrors the constants and derivation logic in ml/app.py (and
 * frontend/src/lib/risk.ts) so mock data demos the same semantics a real
 * /predict response would have. If the backend's boundaries change, update
 * every copy.
 */
